                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <form action="{{ route('admin.lates.edit', $item['id']) }}" method="">
                                        <button type="submit" class="btn btn-info text-white m-2" style="background: rgb(3, 3, 255);">Edit</button>
                                    </form>
                                    <form action="{{ route('admin.lates.delete', $item['id']) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-info text-white m-2" style="background: #ff0000">Hapus</button>
                                    </form>
                                </div>
                            </td>
                            @endif
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <form action="{{ route('admin.lates.edit', $item['id']) }}" method="">
                                        <button type="submit" class="btn btn-info text-white m-2"
                                            style="background: green;">Edit</button>
                                    </form>
                                    <form action="{{ route('admin.lates.delete', $item['id']) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-info text-white m-2"
                                            style="background: red;">Hapus</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
